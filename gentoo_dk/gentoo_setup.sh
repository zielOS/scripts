...
cd /mnt/gentoo && wget https://bouncer.gentoo.org/fetch/root/all/releases/amd64/autobuilds/20230611T170207Z/stage3-amd64-hardened-openrc-20230611T170207Z.tar.xz && tar xpvf stage3-*.tar.xz --xattrs-include='*.*' --numeric-owner
...
** miscellenous apps
emerge -aq app-arch/unzip app-arch/zip app-arch/unrar sys-fs/btrfs-progs sys-fs/dosfstools net-misc/wget net-misc/curl app-misc/neofetch app-misc/ckb sys-power/upower app-admin/sudo app-text/zathura app-text/zathura-meta dev-python/pynvim app-editors/neovim sys-apps/ripgrep sys-apps/fd app-shells/zsh app-shells/zsh-completions app-shells/gentoo-zsh-completions app-shells/zoxide dev-util/fnm app-shells/fzf sys-fs/fuse:0 sys-apps/flatpak dev-vcs/lazygit x11-misc/xdg-user-dirs x11-misc/xdg-user-dirs-gtk x11-misc/xdg-utils xfce-base/thunar xfce-base/tumbler xfce-base/thunar-volman xfce-extra/thunar-archive-plugin xfce-extra/thunar-media-tags-plugin gnome-base/gvfs  media-gfx/feh x11-misc/rofi x11-misc/dunst media-gfx/flameshot x11-misc/xsel x11-misc/xclip x11-misc/betterlockscreen xfce-base/xfce4-power-manager x11-apps/xsetroot x11-base/xorg-server x11-base/xorg-drivers x11-drivers/nvidia-drivers x11-apps/mesa-progs app-forensics/aide sys-apps/rng-tools sys-apps/haveged app-forensics/lynis sys-apps/firejail sys-process/audit app-admin/sysstat sys-apps/apparmor sys-apps/apparmor-utils sys-libs/libapparmor sec-policy/apparmor-profiles sys-process/acct app-backup/snapper app-backup/grub-btrfs sys-boot/grub sys-apps/mlocate media-gfx/sxiv app-misc/fdupes sys-power/acpi app-misc/tmux app-admin/keepassxc www-client/brave-bin x11-wm/bspwm  x11-misc/dunst gui-apps/eww x11-misc/polybar 
...
GRUB_CMDLINE_LINUX="quiet crypt_root=UUID=6a914cf7-63eb-4dfe-ac19-718dfde4c501 root_trim=yes"
