...
sudo install -Dm755 -g root -o root References/Linux/scripts/_out_bin/ivpn-service "/usr/bin/ivpn-service" && sudo install -Dm700 -g root -o root References/Linux/etc/client.down "/opt/ivpn/etc/client.down" && sudo install -Dm700 -g root -o root References/Linux/etc/client.up "/opt/ivpn/etc/client.up" && sudo install -Dm700 -g root -o root References/Linux/etc/firewall.sh "/opt/ivpn/etc/firewall.sh" && sudo install -Dm700 -g root -o root References/Linux/etc/splittun.sh "/opt/ivpn/etc/splittun.sh" && sudo install -Dm600 -g root -o root References/common/etc/servers.json "/opt/ivpn/etc/servers.json" && sudo install -Dm400 -g root -o root References/common/etc/ca.crt "/opt/ivpn/etc/ca.crt" && sudo install -Dm400 -g root -o root References/common/etc/ta.key "/opt/ivpn/etc/ta.key" && sudo install -Dm755 -g root -o root References/Linux/_deps/wireguard-tools_inst/wg-quick "/opt/ivpn/wireguard-tools/wg-quick" && sudo install -Dm755 -g root -o root References/Linux/_deps/wireguard-tools_inst/wg "/opt/ivpn/wireguard-tools/wg" && sudo install -Dm755 -g root -o root References/Linux/_deps/obfs4proxy_inst/obfs4proxy "$pkgdir/opt/ivpn/obfsproxy/obfs4proxy" && sudo install -Dm755 -g root -o root References/Linux/_deps/dnscryptproxy_inst/dnscrypt-proxy "/opt/ivpn/dnscrypt-proxy/dnscrypt-proxy" && sudo install -Dm400 -g root -o root References/common/etc/dnscrypt-proxy-template.toml "/opt/ivpn/etc/dnscrypt-proxy-template.toml"
